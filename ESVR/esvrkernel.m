function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY] = esvrkernel(TrainingData_File, TestingData_File, Regularization_coefficient, Kernel_type, Kernel_para)
...
Omega_train=Omega_train+ones(NumberofTrainingData,NumberofTrainingData);
...
Omega_test=Omega_test+ones(NumberofTrainingData,NumberofTestingData);
